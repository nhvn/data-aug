...
class ImageHandler:
    ...
    def generate_from_image(self, input_image):  # This was the missing method name!
        ...
        if self.use_api:
            ...
            print("Using GAN for generation")
            ...
            for resp in answers:
                for artifact in resp.artifacts:
                    if artifact.type == generation.ARTIFACT_IMAGE:
                        ...
                        # Verify the size of generated image
                        img_bytes = io.BytesIO(artifact.binary)
                        gen_img = Image.open(img_bytes)
